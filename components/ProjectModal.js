...
export default function ProjectModal({ title, imgSource, description, link }) {
  ...
  return (
    <div className={link ? `cursor-pointer` : `cursor-default`}>
      <div onClick={() => router.push(link)} className="flex gap-4 items-center group/project lg:group-hover/projects:opacity-40 lg:group-hover/projects:hover:hover:opacity-100 transition-all duration-200 bg-slate-800 rounded-xl p-5 lg:hover:bg-slate-700">
