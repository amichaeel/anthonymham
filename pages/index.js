      ...
      <main className="px-4">
        <section className="pb-16">
          <h1 className="font-semibold text-4xl mb-4 text-white">
            ...
            <br />
            <span className=" text-3xl text-white/60">Software Engineer</span>
          </h1>
        ...
        <section className="pb-16 pt-10">
          ...
          <div className="group">
            <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
              ...
              <div className="cursor-default flex gap-4 lg:group-hover:opacity-30 lg:group-hover:hover:opacity-100 bg-slate-800 lg:hover:bg-slate-700 lg:w-full rounded-xl text-white transition-all duration-30">
                <div className="p-3">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <a className="text-white/70 text-sm lg:hover:text-teal-300 transition-all w-fit duration-300 group/link" target="_blank" href="https://buildyourfuture.withgoogle.com/programs/tech-exchange">
              ...
              <div className="cursor-default flex gap-4 lg:group-hover:opacity-30 lg:group-hover:hover:opacity-100 bg-slate-800 lg:hover:bg-slate-700 w-full rounded-xl text-white transition-all duration-300">
                <div className="p-3">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <a className="text-white/70 text-sm lg:hover:text-teal-300 transition-all w-fit duration-300 group/link" target="_blank" href="https://www.apple.com/racial-equity-justice-initiative/pdf/2023-Impact-Overview.pdf">
                      Visit Program Website <FontAwesomeIcon className="lg:group-hover/link:translate-x-2 transition-transform duration-300" icon={faArrowRight} />
                    </a>
                  </div>
                </div>
              ...
              <div className="cursor-default md:col-span-2 flex gap-4 lg:group-hover:opacity-30 lg:group-hover:hover:opacity-100 bg-slate-800 lg:hover:bg-slate-700 w-full rounded-xl text-white transition-all duration-300">
                <div className="p-3">
                  <div className="flex items-center space-x-2 justify-start mb-2">
                    <div className="text-white/70 items-center text-4xl">
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <a className="text-white/70 text-sm lg:hover:text-teal-300 transition-all w-fit duration-300 group/link" target="_blank" href="https://flit-gap.org/">
                      Visit Program Website <FontAwesomeIcon className="lg:group-hover/link:translate-x-2 transition-transform duration-300" icon={faArrowRight} />
                    </a>
                  </div>
                </div>
